...
public final class DesaplicarPromocion {
    private DesaplicarPromocion(){}

    public static void desaplicar(
        ...
        if(prendaPromocionadaRepository.existsById(prendaPromocionadaPkey)) {
            ...
            prendaPromocionadaRepository.delete(prendaPromocionada);
            prenda.desaplicarPromocion(BigDecimal.valueOf(promocion.getDescuento()));
